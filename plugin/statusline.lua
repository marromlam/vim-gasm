...
local H = require('luavim.core.highlights')
...
local function colors()
  ...
  local warning_fg = core.style.lsp.colors.warn

  local error_color = core.style.lsp.colors.error
  local info_color = core.style.lsp.colors.info
...
-- set the statusline
vim.o.statusline = '%{%v:lua.core.ui.statusline()%}'
