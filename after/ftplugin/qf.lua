...
vim6.adjust_split_height(3, 10)
opt.winfixheight = true
----------------------------------------------------------------------------------
-- Helper functions
----------------------------------------------------------------------------------
map("n", "dd", vim6.qf.delete, { desc = "delete current quickfix entry", buffer = 0 })
map("v", "d", vim6.qf.delete, { desc = "delete selected quickfix entry", buffer = 0 })
----------------------------------------------------------------------------------
-- Mappings
----------------------------------------------------------------------------------
