...
local icons, highlight, border, palette =
  pde.ui.icons, pde.highlight, pde.ui.current.border, pde.ui.palette

pde.debug = { layout = { ft = { dart = 2 } } }
...
return {
  {
    ...
    keys = {
      ...
      {
        '<localleader>duc',
        function() require('dapui').close(pde.debug.layout.ft[vim.bo.ft]) end,
        desc = 'dap ui: close',
      },
      {
        '<localleader>dut',
        function() require('dapui').toggle(pde.debug.layout.ft[vim.bo.ft]) end,
        desc = 'dap ui: toggle',
      },
      {
        '<localleader>dt',
    ...
    config = function()
      ...
      dap.listeners.after.event_initialized['dapui_config'] = function()
        dapui.open(pde.debug.layout.ft[vim.bo.ft])
      end
    end,
    dependencies = {
      {
