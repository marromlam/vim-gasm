local highlight, ui, k = pde.highlight, pde.ui, pde.replace_termcodes
local api = vim.api
        ...
        formatting = {
          ...
          format = lspkind.cmp_format({
            ...
            before = function(_, vim_item)
              local label, length =
                vim_item.abbr, api.nvim_strwidth(vim_item.abbr)
              if length < MIN_MENU_WIDTH then
                vim_item.abbr = label
                  .. string.rep(' ', MIN_MENU_WIDTH - length)
              end
              return vim_item
            end,
            menu = {
