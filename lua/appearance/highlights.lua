local highlights = {
  ...
  PmenuSel = { fg = C.bg_alt, bg = C.blue },
  WildMenu = { fg = C.bg_alt, bg = C.blue },
  CursorLineNr = { fg = C.light_gray, style = "bold" },
  Comment = { fg = C.gray, style = "italic" },
  Folded = { fg = C.accent, bg = C.bg_alt },
  FoldColumn = { fg = C.accent, bg = C.bg_alt },
  LineNr = { fg = C.gray },
  FloatBoder = { fg = C.gray, bg = C.bg_alt },
  Whitespace = { fg = C.bg },
  VertSplit = { fg = C.bg, bg = C.line_bg },
  ...
  DiffAdd = { fg = C.bg_alt, bg = C.sign_add },
  DiffChange = { fg = C.bg_alt, bg = C.sign_change, style = "underline" },
  DiffDelete = { fg = C.bg_alt, bg = C.sign_delete },
  ...
  ErrorMsg = { fg = C.error, bg = C.bg, style = "bold" },
  ...
  Error = { fg = C.error, bg = C.bg, style = "bold" },
  -- barbar tabline
  TabLine = { fg = C.light_gray, bg = C.line_bg },
  TabLineSel = { fg = C.white, bg = C.line_bg , style = "bold"},
  TabLineFill = { fg = C.white, bg = C.line_bg },
}
