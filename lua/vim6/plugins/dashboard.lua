...
local icons, highlight = vim6.ui.icons, vim6.highlight
...
return {
  ...
  config = function()
    ...
    highlight.plugin("alpha", {
      { StartLogo1 = { fg = "#1C509B" } },
      { StartLogo2 = { fg = "#1D5D98" } },
      { StartLogo3 = { fg = "#1E6995" } },
      { StartLogo4 = { fg = "#1F7592" } },
      { StartLogo5 = { fg = "#22828F" } },
      { StartLogo6 = { fg = "#238E8C" } },
      { StartLogo7 = { fg = "#249B89" } },
      { StartLogo8 = { fg = "#25A785" } },
    })
    ...
    local function footer()
      return vim.fn.printf("%.2f", 1000 * vim.fn.reltimefloat(vim.fn.reltime(vim.g.start_time))) .. " ms"
    end

    local installed_plugins = {
      type = "text",
      val = f(" %d plugins loaded in ", vim6.installed_plugins()) .. footer(),
      opts = { position = "center", hl = "NonText" },
    }
    ...
    local function get_sessions(limit)
      ...
      local sessions_by_dir = vim6.fold(function(accum, item, index)
