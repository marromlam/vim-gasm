...
require("fzf-lua").setup {
  ...
  colorschemes = {
    ...
    winopts = { height = 0.35, width = 0.30 },
...
require("which-key").register({
  ["l"] = {
    ...
    ["q"] = { "<cmd>FzfLua quickfix<cr>" }, -- builtins.lsp_document_symbols "Quickfix")
    ["s"] = { "<cmd>FzfLua lsp_document_symbols<cr>" }, -- builtins.lsp_document_symbols "Document Symbols")
    ["w"] = { "<cmd>FzfLua lsp_live_workspace_symbols<cr>" }, -- builtins.lsp_dynamic_workspace_symbols "Workspace Symbols")
  },
...
require("which-key").register({
  ["<leader>"] = { "<cmd>FzfLua files<cr>", "Find file" }, -- builtins.find_files core.map({'n'}, "<leader>ff", "<cmd>Telescope find_files<cr>", "Find File") -- builtins.find_files
  ["b"] = { "<cmd>FzfLua buffers<cr>", "Search in current buffer" },
  ["f"] = {
    name = "find",
    ["b"] = { "<cmd>FzfLua lgrep_curbuf<cr>", "Search in current bufferr" },
    ["c"] = { "<cmd>FzfLua colorscheme<cr>", "Colorscheme" },
    ["C"] = { "<cmd>FzfLua commands<cr>", "Commands" },
    ["d"] = { "<cmd>FzfLua files cwd=~/.dotfiles<cr>", "Dotfiles" },
    ["g"] = { "<cmd>FzfLua live_grep<cr>", "Live grep text" },
    ["m"] = { "<cmd>FzfLua man_pages<cr>", "Man Page" },
    ["n"] = { "<cmd>FzfLua files cwd=~/.config/nvim<cr>", "Dotfiles" },
    ["r"] = { "<cmd>FzfLua oldfiles<cr>", "Open Recent File" },
    ["R"] = { "<cmd>FzfLua registers<cr>", "Registers" },
    ["k"] = { "<cmd>FzfLua keymaps<cr>", "Keymaps" },
    ["?"] = { "<cmd>FzfLua help_tags<cr>", "Find Help" }, -- builtins.help_tags
  },
}, { mode = "n", buffer = nil, silent = true, noremap = true, nowait = true, prefix = "<leader>" })
