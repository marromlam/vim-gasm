...
M.setup = function()
  vim.g.vsnip_snippet_dir = nvim.vsnip_dir
  ...
  compe.setup(nvim.builtin.compe)
  ...
  local keymap = require "keys.mappings"
  keymap.load(nvim.builtin.compe.keymap.values, nvim.builtin.compe.keymap.opts)
end
